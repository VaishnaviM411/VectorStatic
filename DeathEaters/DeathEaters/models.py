...
class HouseHolds(models.Model):
    ...
    wardNo = models.IntegerField(default=0,max_length=100)
    adhar = models.BigIntegerField(max_length=12,primary_key=True) 
...
class HouseListing(models.Model):
    ...
    FloorMaterial = models.CharField(max_length=1, choices=FLOOR_CHOICES)
    WallMaterial = models.CharField(max_length=1,choices=WALL_CHOICES)
    RoofMaterial = models.CharField(max_length=1,choices=ROOF_CHOICES)
    UseOfHouse = models.CharField(max_length=1,choices=USE_CHOICES)
    TotalResidents = models.IntegerField()
    HeadName = models.CharField(max_length=200)
    HeadSex = models.CharField(max_length=1,choices=SEX_CHOICES)
    HeadCaste = models.CharField(max_length=1,choices=CASTE_CHOICES)
    ...
    DrinkingWaterSource = models.CharField(max_length=1,choices=DWATERSOURCE_CHOICES)
    DrinkingWaterAvail = models.CharField(max_length=1,choices=DWATERAVAIL_CHOICES)
    LightingSource = models.CharField(max_length=1,choices=LIGHTING_CHOICES)
    LatrineAccess = models.CharField(max_length=1,choices=LATRINEACCESS_CHOICES)
    LatrineType = models.CharField(max_length=1,choices=LATRINETYPE_CHOICES)
    WasteWaterOutlet = models.CharField(max_length=1,choices=WASTEWATER_CHOICES)
    BathingFacility = models.CharField(max_length=1,choices=BATHINGFACILITY_CHOICES)
    Kitchen = models.CharField(max_length=1,choices=KITCHEN_CHOICES)
    KitchenFuel = models.CharField(max_length=1,choices=FUEL_CHOICES)
    Radio = models.CharField(max_length=1,choices=RADIO_CHOICES)
    Television = models.CharField(max_length=1,choices=TELEVISION_CHOICES)
    Internet = models.CharField(max_length=1,choices=INTERNET_CHOICES)
    ComputingDevice = models.CharField(max_length=1,choices=DEVICE_CHOICES)
    Phone = models.CharField(max_length=1,choices=PHONE_CHOICES)
    TwoWheeler = models.CharField(max_length=1,choices=TWOWHEELER_CHOICES)
    FourWheeler = models.CharField(max_length=1,choices=FOURWHEELER_CHOICES)
    Cereal = models.CharField(max_length=1,choices=CEREAL_CHOICES)
